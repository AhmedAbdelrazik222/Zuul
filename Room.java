...
public class Room 
{
    ...
    protected static ArrayList<Room> rooms = new ArrayList<Room>();     // ArrayList for all rooms 
     ...
     * 
     * @returns ArrayList of all items in the room
     */
    ...
    /**
     * Removes the specified from the room
     * 
